...
local function OpenMenu()
    MainFrame.Position = UDim2.new(0.5, -160, 0.5, -210 + 80)
    MainFrame.BackgroundTransparency = 1
    MainFrame.Visible = true
    TweenService:Create(MainFrame, TweenInfo.new(0.5, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Position = UDim2.new(0.5, -160, 0.5, -210)}):Play()
    TweenService:Create(MainFrame, TweenInfo.new(0.4), {BackgroundTransparency = 0}):Play()
end

local function CloseMenu()
    TweenService:Create(MainFrame, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Position = UDim2.new(0.5, -160, 0.5, -210 - 80)}):Play()
...
local function ShowTab(tabName)
    currentTab = tabName
    -- Aquí puedes ocultar/mostrar frames de contenido por tab, pero por simplicidad usamos solo uno por ahora
end

local TabAimbot = Instance.new("TextButton")
TabAimbot.Size             = UDim2.new(0.33, -4, 0, 40)
TabAimbot.Position         = UDim2.new(0, 4, 0.12, 0)
...
TabESP.Size = UDim2.new(0.33, -4, 0, 40)
TabESP.Position = UDim2.new(0.33, 2, 0.12, 0)
TabESP.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
...
TabVisual.Size = UDim2.new(0.33, -4, 0, 40)
...
-- Contenido (por ahora todo en uno, puedes agregar frames separados después)
...
ToggleESP.Position = UDim2.new(0.05, 0, 0.35, 0)
...
ToggleChams.Position = UDim2.new(0.05, 0, 0.50, 0)
...
-- Animación pulsación logo
spawn(function()
    while true do
        TweenService:Create(FloatBtn, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {ImageTransparency = 0.2}):Play()
        wait(1.5)
        TweenService:Create(FloatBtn, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {ImageTransparency = 0}):Play()
        wait(1.5)
    end
end)
...
print("Flux Cheats v1.7 cargado! 🔥 Menú rayo con tabs | INSERT = menú | X = mouse lock | Y = aimbot | Discord izquierdo")